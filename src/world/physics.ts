...
/**
 * The physics engine of the universe: the causal chain from a
 * star's disk chemistry to a body's inventory, gravity, air,
 * seas, palette and life. The charter and every named constant
 * live in `universe.ts` (re-exported here so the import graph
 * did not move); this file is the laws.
 */
