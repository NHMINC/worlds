...
export const LIVE_KNOBS: LiveKnob[] = [
  ...
  },
  {
    ...
    about: 'The one opacity slider. 0 is clear; the reddened skin, the starlight wall, and the background veil all grade with it, reaching fully dark cores at 6. Does not grow the ribbons. Next frame.',
    uniform: 'uExtinctK',
    min: 0,
    max: 16,
    step: 0.05,
  ...
  },
  {
    ...
    about: 'Starlight only: density at or above this is a wall — at full Dust extinction no star shines through a ribbon core, and lower extinction grays the wall out with everything else. The edge is a ramp (not a hard clip) so the Cartesian bake does not print 45° diamonds. The cosmic background ignores this — the dust-floor veil covers it. Next frame.',
