...
export const LIVE_KNOBS: LiveKnob[] = [
  ...
  },
  {
    ...
    about: 'Field below this is not a cloud. The bake stores the raw photograph, so this carves it live — lower = more, softer clouds; higher = fewer, darker patches. Also where the inside-a-cloud night begins. Next frame.',
    uniform: 'uExtinctCut',
    min: 0.01,
    max: 0.7,
    step: 0.01,
