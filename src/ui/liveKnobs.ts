...
export const REBUILD_KNOBS: RebuildKnob[] = [
  ...
  },
  {
    ...
    label: 'Clump stretch',
    group: 'dust',
    hint: '1 = round; higher = flatter in the disk',
    about: 'Flattens photograph clumps in the plane. 1 is round fluff. This is not the old along-arm shear — that made one infinitely long snake. Needs rebake.',
    scope: 'dust',
