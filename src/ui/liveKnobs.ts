...
export const LIVE_KNOBS: LiveKnob[] = [
  ...
  },
  {
    ...
    group: 'dust',
    hint: 'look-test: lime ribbons on the sky',
    about: 'Look test, not a colour of the universe. 0 is the real law — dust is extinction, never drawn. 1 paints a shaded lime skin on the death-smear filaments (ribbons / sausages) in the gaps, not on the stars. Next frame.',
    uniform: 'uDustDebug',
    min: 0,
    max: 1,
    step: 1,
