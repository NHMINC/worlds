...
export const LIVE_KNOBS: LiveKnob[] = [
  ...
  },
  {
    ...
    about: 'Look test, not a colour of the universe. 0 is the real law — dust is extinction, never drawn. 1 paints a bright lime skin on the last baked filaments so you can size and shape them. Change Dust count / Smear lifetime and Rebuild, then the lime is the new bake. Stars stay themselves. Next frame.',
    uniform: 'uDustDebug',
    min: 0,
    max: 1,
    step: 1,
...
export const REBUILD_KNOBS: RebuildKnob[] = [
  ...
  },
  {
    ...
    label: 'Dust count',
    group: 'dust',
    hint: 'how many dusty deaths are in the photograph',
    about: 'Photograph budget for death smears. Occupancy × this ≈ how many sausages you get. Lower if the disc is a wall of pockets. 1 is a handful; hundreds fill the disc. Needs rebake.',
    scope: 'dust',
    ...
    write: (v) => writeNum('GALAXY_DUST_EVENT_K', Math.round(v)),
  },
  {
    id: 'dustM',
  ...
  },
  {
    ...
    group: 'dust',
    hint: 'how long a wake shears around the disc (Gyr)',
    about: 'How long a death stays in the photograph. Each wake is the same ash stretched along the shear — a long twirl is thinner, so it does not black out the disc. Older deaths wrap further. Needs rebake.',
    scope: 'dust',
  ...
  },
  {
    ...
    about: 'Ash in one death before it is stretched along the wake. Higher and a young pocket is denser; long smears still thin out. Needs rebake.',
    scope: 'dust',
